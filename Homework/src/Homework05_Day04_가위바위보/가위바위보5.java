...
public class 가위바위보5 {// time[06:48]
	/*
	 * 가위바위보게임[10]
		...
		while(true) {
			...
			if(사용자==3) {
				if(사용자승수>컴퓨터승수) {
					...
					System.err.println("총 게임 횟수 :"+게임수);
					System.err.println("사용자 총 승리 횟수 : "+사용자승수);
				}
				else if (사용자승수==컴퓨터승수) {
					...
					System.err.println("총 게임 횟수 :"+게임수);
					System.err.println("컴퓨터 총 승리 횟수 : "+컴퓨터승수);
