...
import java.util.Scanner; // import : 가져오다  library 에서
...
public class Day01_04 { //c.s
	...
	public static void main(String[] args) { //m.s
		...
		// 2. 입력 받을 데이터 안내
		System.out.print(" 이름 : ");
		// 3. 입력 받은 데이터를 가져오기 -> 다른곳(String:문자열) 에 저장
		String 이름 = 입력객체.next();
			 //  =  : 대입 (오른쪽 값이 왼쪽 저장 [대입])
		
		//   안내 출력      // 입력 받아 다른 객체로 저장 
		...
		System.out.println(이름+"\t"+교시1+"\t"+교시2+"\t"+교시3); // 위에서 선언된 이름은 문자 처리 X ;
     						//  변수[객체]+" 문자열 "
