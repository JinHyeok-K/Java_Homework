...
public class Day04_04_배열 { //  c s
	
	public static void main(String[] args) { //m s
		
		// 데이터 저장 1개 -> 변수
		// 배열 [ 특정(인덱스) 기준으로 나열]
			// *  동일한 여러개의 변수를 저장 /관리 : int 는 int끼리 | char는 char 끼리 등등
			// 1. 인덱스 : 저장되는 순서번호[ 0번 시작 ~ ]
			// 2. [ ] : 대괄호 사용한다.
			// 3. 동일한 자료형의 여러 변수를 관리
		// 선언
			// 1. 자료형[] 배열명;		2.자료형 배열명[];
			// 3. 자료형[] 배열명 = { 데이터1, 데이터2,~~~,데이터n}
		...
		// 배열의 길이
			// 1. 배열명.length : 배열 내 총 길이 [변수의 갯수]
		
		// for 와 배열 활용
			// for (  자료형 임시변수 : 배열명 ) { }
			// 배열 내 0번 인덱스로부터 끝 인덱스까지 하나씩 임시변수에 대입 반복 처리 
		...
		// * 83, 90, 87 이라는 int 형 데이터 3개를 저장하는 배열 선언
			...
			// 87 -> 2번 인덱스에 저장
		// 배열 출력
		System.out.println("scores : "+ scores); // 배열 이름 호출 시 -> 메모리 주소 값
